...
highlight Normal ctermfg=15 ctermbg=black guifg=#ffffff guibg=#000000
...
" Split area area
highlight StatusLine ctermfg=15 ctermbg=0 guifg=#d0d0d0 guibg=#5f0000
highlight StatusLineNC ctermfg=237 ctermbg=244 guifg=#d0d0d0 guibg=#3a3a3a
highlight VertSplit ctermfg=237 ctermbg=244 guifg=#d0d0d0 guibg=#3a3a3a
...
" Other
highlight Directory ctermfg=74 guifg=#5fafd7
highlight LineNr ctermfg=244 ctermbg=235 guifg=#808080 guibg=#262626
highlight NonText ctermfg=239 ctermbg=black guifg=#505050 guibg=#222222
